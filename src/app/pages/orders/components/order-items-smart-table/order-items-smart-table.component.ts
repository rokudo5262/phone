...
@Component({
  selector: 'ngx-order-items-smart-table',
  templateUrl: './order-items-smart-table.component.html',
  styleUrls: ['./order-items-smart-table.component.scss'],

})
export class OrderItemsSmartTableComponent implements OnInit {
  settings = {
    hideSubHeader: false,
    // selectMode: 'multi',
    // edit: {
